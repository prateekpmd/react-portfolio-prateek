        ...
        <div className="w-full lg:w-1/2">
          <div className="flex flex-col justify-center items-center lg:items-start">
            <motion.h1
              ...
              initial="hidden"
              animate="whileInView"
              className="pb-16 text-8xl flex font-extrabold  tracking-tight lg:mt-16 lg:text-8xl lg:text-left md:text-left sm:text-center xxs:text-center xxxs:text-center"
            >
              Prateek Premanand
            </motion.h1>
            <motion.span
